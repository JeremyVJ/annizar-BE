...
<head>
    ...
    <meta name="description" content="Anizzar Catering inong">
    <meta name="author" content="Anizzar Catering Inong">

    <title>Anizzar Catering Inong</title>
...
<body>
    ...
    <footer style="margin-bottom:0">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; 2023 - <a href="{{ url('/') }}">Anizzar Catering Inong. </a>All Rights Reserved
